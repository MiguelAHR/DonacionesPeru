                            ...
                            <div class="card border-0 bg-light mb-4">
                                <div class="card-body text-center p-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" class="btn btn-outline-success btn-lg w-100 py-3" 
                                                    onclick="window.location.href = '<%= request.getContextPath()%>/donador/dashboard?tab=donations'">
                                    ...
                                    <div class="card donation-card border-0 shadow-sm mb-3">
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-2 text-center">
                                                    <span class="status-badge <%="pending".equals(donation.getStatus()) ? "bg-warning"
