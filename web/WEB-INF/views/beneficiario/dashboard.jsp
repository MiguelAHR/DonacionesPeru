                                ...
                                <div class="card-body text-center p-4">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <button type="button" class="btn btn-outline-warning btn-lg w-100 py-3" 
                                                    onclick="window.location.href = '<%= request.getContextPath()%>/beneficiario/dashboard?tab=requests'">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-md-2 text-center">
                                                    <span class="fw-bold">Prioridad: 
                                                          <span class="badge <%=solicitud.getPriority() >= 4 ? "bg-danger"
                                                ...
                                                <div class="col-md-2 text-center">
                                                    <span class="status-badge <%="pending".equals(solicitud.getStatus()) ? "bg-warning"
